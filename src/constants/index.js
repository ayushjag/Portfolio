...
export const PROJECTS = [
  ...
  {
    title: " Full Stack Music Streaming App",
    image: project3,
    description:
      "Melofy is your go-to app for streaming music anytime, anywhere. With a simple and sleek design, it allows users to explore a vast library of songs, create playlists, and enjoy a personalized music experience. Whether you're into the latest hits or classic tunes, Melofy has it all!",
    technologies: ["React", "Express", "Node", "MongoDB","Cloudinary", "Tailwind"],
    link: "https://ayush-melofy.vercel.app/",
  },
  {
